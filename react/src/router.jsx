    ...
    import Provincie_FAQ from "./views/provincie/Provincie_FAQ.jsx";
    import Collectief_FAQ from "./views/collectief/Collectief_FAQ.jsx";
    import Provincie_OverzichtCollectief from "./views/provincie/Provincie_OverzichtCollectief.jsx";
    import Collectief_404 from "./views/collectief/Collectief_404.jsx";
    import Collectief_Unauthorized from "./views/collectief/Collectief_Unauthorized.jsx";
    import Beheerder_404 from "./views/beheerder/Beheerder_404.jsx";
    import Beheerder_Unauthorized from "./views/beheerder/Beheerder_Unauthorized.jsx";
    import Provincie_404 from "./views/provincie/Provincie_404.jsx";
    import Provincie_Unauthorized from "./views/provincie/Provincie_Unauthorized.jsx";
            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {
                            path: '/bedrijf/unauthorized',
                            element: <Bedrijf_Unauthorized/>,
                        },
                    ],
                },
            ],
            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {
                            path: '/provincie/scores/collectief',
                        ...
                        {
                            path: '/provincie/faq',
                            element: <Provincie_FAQ/>
                        },
                        {
                            path: '*',
                            element: <Provincie_404/>
                        },
                        {
                            path: '/unauthorized',
                            element: <Provincie_Unauthorized/>,
                        },
                    ],
                },
            ],
            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {
                            path: '*',
                            element: <Beheerder_404/>
                        },
                        {
                            path: '/unauthorized',
                            element: <Beheerder_Unauthorized/>,
                        },
                    ],
                },
            ],
            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        {
                            path: '/collectief/faq',
                            element: <Collectief_FAQ/>
                        },
                        {
                            path: '*',
                            element: <Collectief_404/>
                        },
                        {
                            path: '/unauthorized',
                            element: <Collectief_Unauthorized/>,
                        },
                    ],
                },
            ],
