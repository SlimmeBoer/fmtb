...
import ScoresTableGebiedAnon from "../../components/data/ScoresTableGebiedAnon.jsx";

export default function Provincie_OverzichtGebied() {
        ...
        <Box sx={{ width: '100%', maxWidth: { sm: '100%', md: '1700px' } }}>
            <Stack direction="row" gap={2} sx={{mb:4}}>
                ...
                <Typography component="h6" variant="h6">
                    {t("pages_provincie.overview_area")}
                </Typography>
            </Stack>
            ...
            {id !== '' && id !== undefined  && <Box>
                ...
                >
                    <Grid size={{xs: 12, lg: 4}}>
                        <ScoresTableGebiedAnon area={id} link={"/provincie/overzicht/individueel/"}/>
                    </Grid>
