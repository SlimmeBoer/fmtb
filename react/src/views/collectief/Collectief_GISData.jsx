...
import GisOverviewCollectief from "../../components/data/GisOverviewCollectief.jsx";

export default function Collectief_GISData() {
    ...
    const confirmRun = () => {
        axiosClient.get(`/gisdump/runcollective`)
            .then(() => {
