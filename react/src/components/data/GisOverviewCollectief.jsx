...
const GisOverviewCollectief = () => {
    ...
    if (!dumps.length) return <Typography variant="p">{t("gis_dumps_overview.none_uploaded_collective")}</Typography>;
...
export default GisOverviewCollectief;
