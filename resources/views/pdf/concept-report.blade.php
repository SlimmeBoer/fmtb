        ...
        <tr class="data-row">
            <td class="main-content">
                <table class="kpi-data">
                    ...
                    <tr>
                        <td>1b</td>
                        <td style="text-align: left">Stikstofbalans bodemoverschot (kg N-totaal per ha) incl. correctie
                            veen
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="border: 0; text-align: left" class="disclaimer">Uitdraai op basis van
                            mogelijk incomplete en niet-geverifieerde gegevens, aan dit rapport kunnen geen rechten
                            worden ontleend.
                        </td>
                        <td style="border: 0;">&nbsp;</td>
                    </tr>
